...
const moduleCompleted = async (learner=0) => {
    ...
    return {enrolled:enrolled,enrolled_len:enrolled.length,completed_len:completed.length,completed:completed,enrolled_not_completed_len:enrolled_not_completed.length,enrolled_not_completed:enrolled_not_completed};
}
